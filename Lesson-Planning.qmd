...
subtitle: "+ Finishing Active Learning"
...
1. **Think**: Take a moment to write down _three_ critiques of this line of evidence, or three questions that you have about its efficacy.
...
```{r echo = FALSE}
countdown::countdown(minutes = 1, bottom = 0, font_size = "2em")
```
...
::: poll
In pairs, take turns sharing each piece of your lesson and classifying them by their E. Write the E on the top of each post-it. 
:::
...
::: poll
In pairs, work to fill out both pages to redesign one person's lesson according to the 5E framework. After 10 minutes, switch over and redesign the other person's lesson
:::

```{r echo = FALSE}
countdown::countdown(minutes = 20, bottom = 0)
```
...
knitr::include_graphics("assets/images/lp-1.png")
```

## Lesson Plan Examples from Cal
```{r out.width=600, out.height = 600, echo = FALSE, fig.align='center'}
knitr::include_graphics("assets/images/lp-2_Page_1.png")
```

## Lesson Plan Examples from Cal
```{r out.width=600, out.height = 600, echo = FALSE, fig.align='center'}
knitr::include_graphics("assets/images/lp-3.png")
```


## Lesson Plan Examples from Cal
```{r out.width=600, out.height = 600, echo = FALSE, fig.align='center'}
knitr::include_graphics("assets/images/lp-4_Page_1.png")
```
...
- Allow for exploration _before_ you explain or give mini-lectures. Spend time thinking about strategies to get students to collaborate and share their thoughts with others and the class.  
